...
//http://www.vogella.com/code/de.vogella.android.listview3d/src/de/vogella/android/listview3d/ListView3d.html
public class ListView3d extends ListView {
	...
	private static final int MAX_INTENSITY = 0xCF;
	...
	protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
		...
		// center of list
		final int parentCenterY = -child.getHeight() / 2;
